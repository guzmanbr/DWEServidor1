            ...
            if (enviado()==false || validarTodo() == false) {
                ?>
                    ...
                    <form action="./indexTarea8.php" method="post" enctype="multipart/form-data">
                        ...
                        <p>
                            <label for="nombre2">Alfabetico Opcional: </label>
                        ...
                        <p>
                            ...
                            <select name="opcionSelect" id="idSelect">
                                ...
                                <option value="2"                         
                                    ...
                                    ?>>Opcion1</option>
                                <option value="3"                        <?
                                        if(enviado() && existe("opcionSelect") && $_REQUEST["opcionSelect"] == "3"){
                                            echo "selected";
                                        }
                                    ?>>Opcion2</option>
                                <option value="4"                        <?
                                        if(enviado() && existe("opcionSelect") && $_REQUEST["opcionSelect"] == "4"){
                                            echo "selected";
                                        }
                                    ?>>Opcion3</option>
                            </select>
