        ...
        public function borrar() {
            ...
            if (count($recurso) == 3) {
                ...
                if (ConciertoDAO::delete($recurso[2])) {
                    ...
                    self::respuesta('',array('Content-Type: application/json', 'HTTP/1.1 200 No se ha borrado ninguno'));
                }           
                
            } else {
                self::respuesta($data, array('HTTP/1.1 400 El recurso está mal formado /conciertos/id'));
            }
        }
    }
